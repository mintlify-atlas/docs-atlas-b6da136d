...
<CardGroup cols={2}>
  ...
  <Card title="Add Image Memory" icon="image" href="/api/memory/add-image">
  ...
  <Card title="Get All Memories" icon="list" href="/api/memory/get-all">
    Retrieve all memories for a user
  </Card>
  
  <Card title="Get Memory" icon="file" href="/api/memory/get">
  ...
  <Card title="Memory History" icon="clock-rotate-left" href="/api/memory/history">
